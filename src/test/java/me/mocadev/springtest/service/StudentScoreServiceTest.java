...
class StudentScoreServiceTest {
  ...
  void getPassStudent() {
    // given
    StudentPass studentPass1 =
        StudentPass.builder().studentName("mocadev").exam("midterm").avgScore(60.0).build();
    StudentPass studentPass2 =
        StudentPass.builder().studentName("mocadev2").exam("midterm").avgScore(70.0).build();
    StudentPass studentPass3 =
        StudentPass.builder().studentName("mocadev2").exam("midterm2").avgScore(70.0).build();
    Mockito.when(studentPassRepository.findAll())
        .thenReturn(List.of(studentPass1, studentPass2, studentPass3));
    ...
    List<ExamPassStudentResponse> response =
        Stream.of(studentPass1, studentPass2)
  ...
  void checkScore1() {
    // given
    StudentScore studentScore = StudentScoreTestDataBuilder.passed().mathScore(90).build();
